...
Do you have trouble with huge red error boxes on your server?  That's because a few  map makers don't pack their button textures/models. The following plugin will fix the issue:
