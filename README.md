...
- Known bug (concerns only windows servers): Stuck at team picture after selecting a team .. you can bypass that by simply disabling the replay bots).. If anyone knows how to fix that add me in steam (1NutWunDeR)
