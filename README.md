...
(Fix for sm vote commands (you can now create your own fixes if have problems with other plugins which need an internal fix ;]): https://forums.alliedmods.net/showpost.php?p=2265536&postcount=487)
