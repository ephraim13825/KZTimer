...
public SaveRecording(client, type)
{
	...
	BuildPath(Path_SM, sPath2, sizeof(sPath2), "data/kz_replays_pro/");
	if(!DirExists(sPath2))
		CreateDirectory(sPath2, 511);
	if (type==0)
	{
		Format(sPath2, sizeof(sPath2), "data/kz_replays_pro/%s.rec", g_szMapName);
		BuildPath(Path_SM, sPath2, sizeof(sPath2), "data/kz_replays_pro/%s.rec", g_szMapName);
	}
	else
	{
		Format(sPath2, sizeof(sPath2), "data/kz_replays_pro/%s_tp.rec", g_szMapName);
		BuildPath(Path_SM, sPath2, sizeof(sPath2), "data/kz_replays_pro/%s_tp.rec", g_szMapName);
	}
...
public LoadReplays()
{
	...
	decl String:sPath2[256]; 
	Format(sPath1, sizeof(sPath1), "data/kz_replays_pro/%s.rec",g_szMapName);
	BuildPath(Path_SM, sPath1, sizeof(sPath1), "data/kz_replays_pro/%s.rec", g_szMapName);
	Format(sPath2, sizeof(sPath2), "data/kz_replays_pro/%s_tp.rec",g_szMapName);
	BuildPath(Path_SM, sPath2, sizeof(sPath2), "data/kz_replays_pro/%s_tp.rec", g_szMapName);		
	g_bProReplay=false;
	g_bTpReplay=false;
...
public PlayRecord(client, type)
{
	...
	if (type==0)
		Format(sPath, sizeof(sPath), "data/kz_replays_pro/%s.rec",g_szMapName);
	else
		Format(sPath, sizeof(sPath), "data/kz_replays_pro/%s_tp.rec",g_szMapName);
...
public DeleteReplay(client, type, String:map[])
{
	decl String:sPath[256]; 
	if (type==1)
		Format(sPath, sizeof(sPath), "data/kz_replays_pro/%s_tp.rec",map);
	else
		Format(sPath, sizeof(sPath), "data/kz_replays_pro/%s.rec",map);
	BuildPath(Path_SM, sPath, sizeof(sPath), "%s", sPath);
